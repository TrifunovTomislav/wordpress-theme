<form action="#" class="sparky-contact-form" id="sparky-contact-form" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
        <div class="form-group">
    <input type="text" 
            class="form-control sparky-form-control" 
    ...
    <div class="form-group">
        <textarea class="form-control sparky-form-control" 
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-default btn-lg btn-sparky-form">Submit</button>
